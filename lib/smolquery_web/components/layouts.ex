defmodule SmolqueryWeb.Layouts do
  @moduledoc """
  The root HTML skeleton and the `app/1` chrome — navbar, flash, theme
  toggle — every LiveView renders inside.
  """
  use SmolqueryWeb, :html
  ...
  def flash_group(assigns) do
    ...
    <div id={@id} aria-live="polite">
      ...
      <.flash
        ...
        hidden
      >
        The connection dropped; the page picks up again on its own
      ...
      <.flash
        ...
        hidden
      >
        The server let the page go; it picks up again on its own
        <.icon name="hero-arrow-path" class="ml-1 size-3 motion-safe:animate-spin" />
      </.flash>
    </div>
    """
