...
| `SMOLQUERY_VICTORIAMETRICS_MAX_SERIES` | The most series one MetricsQL selector may match on the VictoriaMetrics edge (`10000`). A query past it answers 422 instead of running |
