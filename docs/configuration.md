...
|---|---|
| `SMOLQUERY_ROLES` | Selects the service subtrees that start (`all`). Use `all`, or a comma-separated subset of `api,ingest,buffer,storage,query,web,pg,clickhouse`. An unknown name fails the boot |
